...
public class CameraActivity extends Activity {
	...
	protected void onActivityResult(int requestCode, 
		...
		if (requestCode == CAPTURAR_IMAGEM) {
	    	...
	    	if (resultCode == RESULT_OK) {
	    		Toast.makeText(this, "Video Gravado!"+data.getDataString(),	Toast.LENGTH_LONG).show();
	    		uri = data.getData();
	    	}else{
				Toast.makeText(this, "Video nao foi Gravado!"+data.getDataString(),Toast.LENGTH_LONG).show();
	    	}
	    }
	}
